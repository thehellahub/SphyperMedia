var w = .95 * window.innerWidth;
var h = .5 * window.innerHeight;
	...
	circles
      ...
      $('svg circle').tipsy({ 
        ...
        title: function() {
          var d = this.__data__;
	  var pDate = d.date;
          return 'Date: ' + pDate.getDate() + " " + monthNames[pDate.getMonth()] + " " + pDate.getFullYear() + '<br>Temperature: ' + d.value + " ℉"; 
        }
      });
}